...
- [X] Scrollview on the photos in the signed in view

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. For some of the optional features, did you create your own assets? 
2. Is there a way to reuse Swift files like CSS classes? 

### Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='Week-1-Dropbox/week 1 - dropbox.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
